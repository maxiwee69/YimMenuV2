...
namespace YimMenu::Features
{
	...
	const char* VehicleHelper::get_mod_name(Hash model, int vehicle, int mod_slot, int mod, int mod_count)
	{
		...
		else
		{
			switch (mod_slot)
			{
			case (int)VehicleModType::MOD_AIRFILTER: 
				break;
	...
	static const std::map<Hash, std::map<int, std::vector<int32_t>>> mod_blacklists = {
		{"BANSHEE"_J, {
			{(int)VehicleModType::MOD_SPOILERS, {3, 4}}, 
			{(int)VehicleModType::MOD_COLUMNSHIFTERLEVERS, {0, 1, 2, 3}}, 
			{(int)VehicleModType::MOD_SPEAKERS, {0}}, 
			{(int)VehicleModType::MOD_LIVERY, {15, 16}}
		}},
		{"SENTINEL"_J, {
			{(int)VehicleModType::MOD_SPOILERS, {4, 5}}, 
			{(int)VehicleModType::MOD_COLUMNSHIFTERLEVERS, {0, 1, 2, 3}}, 
			{(int)VehicleModType::MOD_SPEAKERS, {0}}, 
			{(int)VehicleModType::MOD_LIVERY, {0, 1}}
		}},
	};
